...
3번째: [앱 형태 & 기술 스택] 앱 형태와 기술 스택
   "이 앱을 어떤 형태로 만들고 싶으신가요?

   ⚠️ 중요: 예시는 초보자도 쉽게 이해할 수 있도록 간단하고 명확하게 작성하세요. 전문 용어는 최소화하고, 일상적인 표현을 사용하세요.
   ...
   🎨 프론트엔드 (화면 개발) 예시:
   - React로 개발 (빠르고 쉬움) ⭐ 추천
   - Next.js로 개발 (구글 검색에 잘 나옴)
   - HTML로 개발 (가장 기본)

   💾 백엔드 (데이터 저장) 예시:
   - 브라우저에 저장 (무료, 간단) ⭐ 추천
   - Firebase로 저장 (여러 기기에서 공유)
   - 서버 만들어서 저장 (복잡하지만 자유도 높음)

   기본 설정:
   - PRD는 /docs/PRD.md, 작업은 /docs/TODOs.md에 기록
   - 초기에는 임시 데이터로 화면만 먼저 만들기"
