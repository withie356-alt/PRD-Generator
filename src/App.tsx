...
3번째: [Typography & Hierarchy] 타이포그래피와 시각적 위계
   "텍스트 스타일은 어떤 웹사이트를 참고하고 싶으세요?

   예시:
   - 네이버: 깔끔하고 읽기 쉬운 기본 폰트, 검색과 콘텐츠 중심
   - 쿠팡: 대담한 타이틀과 명확한 가격 표시, 쇼핑 최적화
   - 유튜브: 영상 제목 강조, 메타 정보(조회수, 날짜) 구분
   - 노션: 깔끔한 위계, 문서 작성에 최적화된 타이포
   - 당근마켓: 친근한 폰트, 동네 커뮤니티 느낌
   - 토스: 모던하고 간결한 금융 서비스 스타일

   (또는 직접 설명해주세요)"

4번째: [Overall Design Style] 전체적인 디자인 스타일
   "어떤 웹사이트의 전체적인 디자인 스타일을 참고하고 싶으세요?

   예시:
   - 쿠팡: 밀집된 레이아웃, 효율적인 공간 활용, 쇼핑 최적화
   - 배달의민족: 넉넉한 여백, 편안한 느낌, 큰 버튼과 이미지
   - 카카오: 심플하고 명확한 구조, 노란색 포인트
   - 라인: 깔끔한 카드 스타일, 부드러운 모서리
   - 에어비앤비: 미니멀하고 세련됨, 큰 이미지 중심
   - 직방/다방: 지도 중심, 필터와 리스트 조합

   (또는 직접 설명해주세요)"

5번째: [User Journey] 사용자 여정
   "사용자가 앱을 열고 주요 목표를 달성하기까지 거치는 핵심 단계를 순서대로 설명해주세요.
...
6번째: [Information Architecture] 정보 구조
